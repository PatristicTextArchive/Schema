...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt">
   ...
   <pattern id="schematron-constraint-gap-15">
      <rule context="tei:gap">
         ...
         <report test="not(@reason='ellipsis') and ancestor::tei:supplied[not(@reason='undefined')]">gap may not appear within supplied text</report>
      </rule>
   </pattern>
   ...
   <pattern id="schematron-constraint-del-18">
      <rule context="tei:subst">
         <assert test="child::tei:del and child::tei:add">Needs del and add as children</assert>
      </rule>
   </pattern>
