...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   ...
   <!-- This file generated 2025-11-25T11:57:40Z by 'extract-isosch.xsl'. -->
   <!-- ********************* -->
   <!-- namespaces, implicit: -->
   <!-- ********************* -->
   <ns prefix="esp-d3e450" uri="http://www.telota.de"/>
   ...
   <pattern id="schematron-constraint-label-13">
   ...
   <pattern id="schematron-constraint-unclear-15">
   ...
   <pattern id="schematron-constraint-gap-16">
   ...
   <pattern id="schematron-constraint-ref-17">
   ...
   <pattern id="schematron-constraint-note-18">
   ...
   <pattern id="schematron-constraint-del-19">
   ...
   <pattern id="schematron-constraint-abbr-20">
